<?php 
  ...
  if($now > $_SESSION['expire']) {
   ...
   if($_REQUEST['id']==null){
      header('Location: ?action=Tipo_foto');
  }
?>
  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Tipo De Imagenes</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Tipo_foto_actualizar" method="post" id="oscurecer">
