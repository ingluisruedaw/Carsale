        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Tipo De Imagenes</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li id="white" class="active">Tipo De Imagenes</li>
                <li><a href="?action=Form_Tipo_foto_Insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach($modelTipo_foto->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                    <form action="?action=Form_Tipo_foto_Actualizar" method="post">
                    ...
                    <td>
                      <form action="?action=<?php echo 'Tipo_foto_eliminar'; ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
