  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Insertar Tipo De Imagenes</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li><a href="?action=Tipo_foto">Tipo De Imagenes</a></li>
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Tipo_foto_registrar" method="post" id="oscurecer">

            <div class="row margin">
              <div class="input-field col s12" id="white">
                <?php
                    $registro=$modelTipo_foto->ObtenerMax();
                  ?>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="det" value="<?php echo $almTipo_foto->__GET('det'); ?>" maxlength="45" required/>
