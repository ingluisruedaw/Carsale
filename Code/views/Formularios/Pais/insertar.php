    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Insertar País</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li><a href="?action=Pais">Paises</a></li>
      ...
      <div id="login-page" align="center">
        ...
        <div class="col s12" >
          ...
          <form class="login-form" action="?action=<?php echo 'Pais_registrar'; ?>" method="post" id="oscurecer">
           
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="id" value="<?php echo $almPais->__GET('id'); ?>" maxlength="2" length="2" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="det" value="<?php echo $almPais->__GET('det'); ?>" maxlength="100" length="100" required/>
