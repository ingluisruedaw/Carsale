    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Rol De Usuario</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li><a href="?action=Roles">Roles De Usuarios</a></li>
      ...
      <div id="login-page" align="center">
        ...
        <div class="col s12" >
          ...
          <form class="login-form" action="?action=<?php echo 'Roles_Actualizar'; ?>" method="post" id="oscurecer">
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="det" value="<?php echo $_REQUEST['det']; ?>" maxlength="45" length="45" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12">
                <button type="submit" class="waves-effect waves-light btn cyan">Actualizar</button>
              </div>
            </div>
