    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Insertar Rol De Usuario</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" align="center">
        ...
        <div class="col s12" >
          ...
          <form class="login-form" action="?action=<?php echo 'Roles_registrar'; ?>" method="post" id="oscurecer">
           
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <?php
                    $registro=$modelRoles->ObtenerMax();
                  ?>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="det" value="<?php echo $almRoles->__GET('det'); ?>" maxlength="45" length="45" required/>
