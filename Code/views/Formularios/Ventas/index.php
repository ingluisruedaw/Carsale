        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Ventas</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li id="white" class="active">Ventas</li>
                <li><a href="?action=Form_Ventas_Insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section container">
          ...
          <div id="input-fields">
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelVentas->Listar() as $r): ?>
                  <tr>
                    <td><?php echo $r->__GET('id'); ?></td>
                    <td>
                      <form class="col s12" action="?action=<?php echo 'Form_Ventas_Reporte'; ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo $r->__GET('carros_id'); ?>">
                        <button type="submit" class="waves-effect waves-light btn col s12 cyan"><?php echo $r->__GET('carros_id'); ?></button>
                      </form>
                    </td>
                    ...
                    <td>
                      <!--<form action="?action=Form_Ventas_Actualizar" method="post">
                          <input type="hidden" name="id" value="<?php //echo $r->id; ?>">
                          <button type="submit" class="btn-floating btn-large waves-effect waves-light cyan"><i class="mdi-editor-mode-edit"></i></button>
                        </form>-->
                    </td>
                    <td>
                    <form action="?action=<?php echo 'Ventas_Eliminar'; ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
