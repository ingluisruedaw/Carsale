<?php 
  ...
  if($_REQUEST['id']==null){
      header('Location: ?action=Tipo_carro');
  }
?>
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Tipos De Vehículos</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" align="center">
        ...
        <div class="col s12" >
          ...
          <form class="login-form" action="?action=<?php echo 'Tipo_carro_actualizar'; ?>" method="post" id="oscurecer">
