<?php 
  ...
  if($_REQUEST['id']==null){
      header('Location: ?action=Tip_docu');
  }
?>
  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Tipos Documentación</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Tip_docu_actualizar" method="post" id="oscurecer">
