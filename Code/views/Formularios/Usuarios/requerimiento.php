        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Requerimiento</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li id="white" class="active">Requerimiento</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section container">
          ...
          <div id="input-fields">
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelUsuarios->Listar_requerimiento() as $r): ?>
                  <tr>
                    <td><?php echo $r->__GET('usuario'); ?></td>
                    <td><?php echo $r->__GET('total'); ?></td>
                    <td><?php echo $r->__GET('carros'); ?></td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
            </table>
