        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Reporte Vehículos Vendidos</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li><a href="?action=Carros">Vehículos</a></li>
                <li id="white" class="active">Vendidos</li>
                <li><a href="?action=Form_Vehiculos_Insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section container">
          ...
          <div id="input-fields">
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelCarros->Listar_Vendidos() as $r): ?>
                  <tr>
                    <td>
                      <form class="col s12" action="?action=<?php echo 'Form_Carro_Reporte'; ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo $r->__GET('id'); ?>">
                        <button type="submit" class="waves-effect waves-light btn"><?php echo $r->__GET('id'); ?></button>
                      </form>
                    </td>
                    ...
                    <td><?php echo $r->__GET('pventa'); ?></td>
                    <td>
                      <form action="?action=Form_Vehiculos_actualizar" method="post">
                    ...
                    <td>
                    <form action="?action=<?php echo 'Carros_eliminar'; ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
