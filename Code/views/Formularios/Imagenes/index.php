        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Imagenes</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li id="white" class="active">Imagenes</li>
                <li><a href="?action=Form_Imagenes_insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section container">
          ...
          <div id="input-fields">
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelImagenes->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                     	<form action="?action=Form_Imagenes_Actualizar" method="post">
                    ...
                    <td>
                    <form action="?action=<?php echo 'Imagenes_eliminar'; ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
                      <input type="hidden" name="foto" value="<?php echo $r->foto; ?>"/>
