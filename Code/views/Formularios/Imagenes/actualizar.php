<?php 
  ...
  if($_REQUEST['id']==null){
      header('Location: ?action=Imagenes');
  }
?>
  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Imagen</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" enctype="multipart/form-data" action="?action=Imagenes_Actualizar" method="post" id="oscurecer">
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <select name="tipo">
                    <?php foreach($modelTipo_foto->Listar() as $r): 
                      if ($_REQUEST['tipo']==$r->det) {?>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="file" id="foto" name="foto" class="foto" data-allowed-file-extensions="jpg jepg png" data-max-file-size="19M" data-default-file="<?php echo $_REQUEST['foto'] ?>"/>
              </div>
            </div>
