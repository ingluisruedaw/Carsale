  <?php 
    ...
    if ($_SESSION['usuarioTemporal']==null) {
      session_unset();
      session_destroy();
...
<body BGPROPERTIES="fixed">
  ...
  <div id="login-page" class="row">
    <div id="oscurecer" class="col s12 z-depth-4 card-panel">
      <form class="login-form" action="?action=Cambiar_Clave_Recuperar" method="post" id="myForm">
        <div class="row">
        ...
        <div class="row margin">
          <div class="input-field col s12">
            ...
            <input id="white" name="usuario" id="usuario" type="text" value="<?php echo $_SESSION['usuarioTemporal']?>" readonly>
        ...
        <div class="row margin">
          <div class="input-field col s12">
            <i class="mdi-social-person-outline prefix"></i>
            <input id="white" name="clave" id="clave" type="password" required>
            <label for="clave" class="center-align" required>Clave</label>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="input-field col s12">
              <button type="submit" class="waves-effect waves-light btn col s12 cyan">Cambiar Clave</button>
            </div>
        </div>
        <div class="row">
          <div class="input-field col s12">
