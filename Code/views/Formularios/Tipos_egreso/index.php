        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Tipo De Egresos</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li id="white" class="active">Tipo De Egresos</li>
                <li><a href="?action=Form_Tipos_egreso_insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach($modelTipos_egreso->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                    	<form action="?action=Form_Tipos_egreso_actualizar" method="post">
                    ...
                    <td>
                      <form action="?action=<?php echo 'Tipos_egreso_eliminar'; ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
