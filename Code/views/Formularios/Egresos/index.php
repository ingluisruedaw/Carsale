          ...
          <div class="row">
            <div class="col s12 m12 l12">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="?action=Form_Egresos_insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach($modelEgresos->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                    	<form action="?action=Form_Egresos_actualizar" method="post">
                    ...
                    <td>
                    <form action="?action=<?php echo 'Egresos_eliminar'; ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
