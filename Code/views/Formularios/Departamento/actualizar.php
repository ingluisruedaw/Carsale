<?php 
  ...
  if($_REQUEST['id']==null){
      header('Location: ?action=Departamento');
  }
?>
  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Departamento</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Departamento_Actualizar" method="post" id="oscurecer">
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="det" value="<?php echo $_REQUEST['det']; ?>" maxlength="100" length="100" required/>
