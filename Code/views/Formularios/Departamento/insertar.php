  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Registrar Departamento</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li><a href="?action=Departamento">Departamentos</a></li>
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Departamento_registrar" method="post" id="oscurecer">

            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="id" value="<?php echo $almDepartamento->__GET('id'); ?>" maxlength="15" length="15" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="det" value="<?php echo $almDepartamento->__GET('det'); ?>" maxlength="100" length="100" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <select name="pais">
                    <?php foreach($modelPais->Listar() as $r): ?>
