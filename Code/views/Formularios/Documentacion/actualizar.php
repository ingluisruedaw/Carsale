<?php 
  ...
  if($_REQUEST['id']==null){
      header('Location: ?action=Documentacion');
  }
?>
  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Documentación</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" enctype="multipart/form-data" action="?action=Documentacion_Actualizar" method="post" id="oscurecer">
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="date" class="datepicker" name="fvence" value="<?php echo $_REQUEST['fvence']; ?>">
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <select name="estado">
                    <?php if ($_REQUEST['estado']=="VIGENTE") {?>
                      <option value="1" selected>VIGENTE</option>
                      <option value="2">VENCIDO</option>
                    <?php }else{?>
                      <option value="1">VIGENTE</option>
                      <option value="2" selected>VENCIDO</option>
                    <?php }?>
                  </select>
                  <label>Tipo De Documentacion</label>
              </div>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="file" id="documento" name="documento" class="foto" data-allowed-file-extensions="jpg jepg png" data-max-file-size="19M"  data-default-file="<?php echo $_REQUEST['documento'] ?>"/>
              </div>
            </div>
