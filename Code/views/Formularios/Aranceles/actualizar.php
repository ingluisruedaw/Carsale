<?php 
  ...
  if($_REQUEST['id']==null){
      header('Location: ?action=Aranceles');
  }
?>
  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Actualizar Arancel</h5>
              <ol class="breadcrumb">
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Aranceles_actualizar" method="post" id="oscurecer">

            <div class="row margin">
              <div class="input-field col s12" id="white">
                <?php
                    $registro=$modelAranceles->ObtenerMax();
                  ?>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="detalle" value="<?php echo $_REQUEST['detalle']; ?>" maxlength="45" length="45" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="number" name="valor" value="<?php echo $_REQUEST['valor']; ?>" required/>
