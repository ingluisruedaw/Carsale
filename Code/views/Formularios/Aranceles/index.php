        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Aranceles</h5>
              <ol class="breadcrumb">
                <li><a href="?action=webmaster">Dashboard</a></li>
                <li id="white" class="active">Aranceles</li>
                <!--<li><a href="?action=Form_Aranceles_registrar">Crear Nuevo</a></li>-->
                <li><a href="?action=Form_Aranceles_registrar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach($modelAranceles->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                    <form action="?action=Form_Aranceles_actualizar" method="post">
                    ...
                    <td>
                    <form action="?action=<?php echo 'Aranceles_eliminar'; ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
