        ...
        <div class="section container">
          ...
          <div id="input-fields">
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelCarros->Listar_PorMarca($_REQUEST['id']) as $r): ?>
                  <tr>
                    <td>
                      <form class="col s12" action="?action=<?php echo 'Secretaria_Form_Carro_Reporte'; ?>" method="post">
...
<!-- START FOOTER -->
<?php include 'views/Vendedor/Footer.php';?>
<!-- END FOOTER -->
