  ...
  <div class="wrapper">
    ...
    <section id="content" >
        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Formulario Insertar Persona</h5>
              <ol class="breadcrumb">
                <li><a href="?action=secretaria">Secretaria</a></li>
                 <li id="white" class="active">Personas Insertar</li>
              </ol>
            </div>
          </div>
        </div>
      ...
      <div id="login-page" class="row" align="center">
        <div class="col s12" >
        <br>
          <form class="login-form" action="?action=Persona_registrar" method="post" id="oscurecer">

            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="id" maxlength="15" length="15" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="nombres" maxlength="45" length="45" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="apellidos" maxlength="45" length="45" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="email" name="email" maxlength="50" length="50" class="validate"/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="direccion" maxlength="45" length="45" required/>
            ...
            <div class="row margin">
              <div class="input-field col s12" id="white">
                <input type="text" name="barrio" maxlength="45" length="45" required/>
