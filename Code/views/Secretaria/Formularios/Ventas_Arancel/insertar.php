          ...
          <div class="row">
            <div class="col s12 m12 l12">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="?action=Secretaria_Form_Ventas_Insertar">Insertar</a></li>
                <li><a href="?action=Secretaria_Ventas_Arancel">Ventas Arancel</a></li>
                  ...
                  <div class="row">
                    <div class="col s6">
                      <form action="?action=Ventas_Cancelar" method="post">
                        ...
                        <button type="submit" class="waves-effect waves-light btn">CANCELAR VENTA</button>
                      </form>
                    </div>
                    ...
                    <div class="col s6" align="right">
                      <form action="?action=Ventas_Finalizar" method="post">
                        <input type="hidden" name="id" value="<?php echo $_SESSION['idfactura'];?>">
                        <button type="submit" class="waves-effect waves-light btn">FINALIZAR VENTA</button>
                      </form>
                    </div>
                  </div>
                </div>
...
<!--<script type="text/javascript">
  function load(carro, responsable, arancel){
    var xmlhttp;
  ...
  xmlhttp.open("POST","views/Formularios/Ventas_Arancel/proc.php",true);
  xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
 
  xmlhttp.send("carro="+carro+"&responsable="+responsable+"&arancel="+arancel);
}
</script>-->
...
<!--<?php 
                                /*$detVAranceles = new detVAranceles();
                                */
                              ?>-->