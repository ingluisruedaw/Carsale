        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 class="breadcrumbs-title">Formulario Ventas Arancel</h5>
              <ol class="breadcrumb">
                <li><a href="?action=secretaria">Secretaria</a></li>
                <li><a href="?action=Secretaria_Ventas">Ventas</a></li>
                <li class="active">Ventas Arancel</li>
                <li><a href="?action=Form_Ventas_Insertar" class="btn-floating btn-large waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach($modelVentas->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                      <form action="?action=Form_Persona_Actualizar" method="post">
                    ...
                    <td>
                    <form action="?action=<?php echo 'Persona_eliminar'; ?>" method="post">
                      <input type="hidden" name="id" value="<?php echo $r->id; ?>"/>
                      <button type="submit" class="btn-floating btn-large waves-effect waves-light cyan"><i class="mdi-action-delete"></i></button>
                    </form>
                    </td>
                  </tr>
                <?php endforeach; ?>
