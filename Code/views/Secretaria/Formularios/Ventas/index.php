          ...
          <div class="row">
            <div class="col s12 m12 l12">
              ...
              <ol class="breadcrumb">
                ...
                <li><a href="?action=Secretaria_Form_Ventas_Insertar" class="btn-floating btn-small waves-effect waves-light cyan"><i class="mdi-content-add"></i></a></li>
              </ol>
            </div>
          </div>
        </div>
              ...
              <tbody>
                <?php foreach($modelVentas->Listar() as $r): ?>
                  <tr>
                    ...
                    <td>
                      <form class="col s12" action="?action=<?php echo 'Secretaria_Form_Ventas_Reporte'; ?>" method="post">
