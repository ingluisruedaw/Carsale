<?php 
  ...
  if ($_REQUEST['id']==null) {
    header('Location: ?action=Admin_Vehiculos_Reporte');
  }else{
        	...
        	<div class="container">
        		<div class="row">
            		<div class="col s12 m12 l12">
              			<h5 id="white" class="breadcrumbs-title">Reporte Hoja De Vida Vehículo</h5>
              			<ol class="breadcrumb">
                			<li><a href="?action=administrador">Administrador</a></li>
                			<li><a href="?action=Admin_Vehiculos_Reporte">Vehículo</a></li>
