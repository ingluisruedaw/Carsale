            ...
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelCarros->Listar_Vendidos() as $r): ?>
                  <tr>
                    <td>
                      <form class="col s12" action="?action=<?php echo 'Admin_Form_Carro_Reporte'; ?>" method="post">
                        <input type="hidden" name="id" value="<?php echo $r->__GET('id'); ?>">
                        <button type="submit" class="waves-effect waves-light btn cols s12 cyan"><?php echo $r->__GET('id'); ?></button>
                      </form>
                    </td>
