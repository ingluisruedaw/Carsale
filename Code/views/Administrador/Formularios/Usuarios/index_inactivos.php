        ...
        <div class="container">
          <div class="row">
            <div class="col s12 m12 l12">
              <h5 id="white" class="breadcrumbs-title">Reporte Usuarios Inactivos</h5>
              <ol class="breadcrumb">
                <li><a href="?action=administrador">Administrador</a></li>
                <li><a href="?action=Admin_Usuarios_Reporte">Usuarios</a></li>
                <li id="white" class="active">Inactivos</li>
              </ol>
            </div>
          </div>
        </div>
        ...
        <div class="section container">
          ...
          <div id="input-fields">
            <table id="data-table-simple" class="responsive-table display" cellspacing="0">
              ...
              <tbody>
                <?php foreach($modelUsuarios->Listar_Inactivos() as $r): ?>
                  <tr>
                    <td>
                      <form class="col s12" action="?action=<?php echo 'Admin_Form_Usuarios_Reporte'; ?>" method="post">
                        <input type="hidden" name="usuario" value="<?php echo $r->__GET('usuario'); ?>">
                        <button id="botones" type="submit" class="waves-effect waves-light btn"><?php echo $r->__GET('usuario'); ?></button>
                      </form>
                    <td>
                      <?php 
                        if($r->__GET('rol')=='1'){
